...
//  */
// export interface PayloadAction<P extends Object, T extends string = string> extends Action<T> {
//   [K in keyof P]: P[K]
// }

export type PayloadAction<P extends {}, T extends string = string> = Action<T> & P
